...
<html>
	<head>
	<title>Learners Academy - New Curriculum</title>
...
<body>
	<div class="container">
     ...
     <h1 style="text-align:center">Set New Curriculum</h1>
								...
								<form action="add" method="POST">								
									<table class="table table-striped">
										...
										<c:forEach var="classes" items="${classes}">
						                    <tr>
						                        <td><input type="radio" name="selected_class" value="${classes.class_name}"> </td>
										...
										<c:forEach var="subjects" items="${subjects}">
						                    <tr>  
						                        <td><input type="checkbox" name="selected_sub" value="${subjects.sub_name}"> </td>
